...
def get_best_indexes(features, feature_id_list, start_logit_list, end_logit_list, args):
    ...
    def generate_mask(feature):
        ...
        for start in range(context_length):
            ...
            # print("start_index: ", start_index, "-----end_index_list: ", end_index_list)
            # print("args.max_enc_seq_length: ",  args.max_enc_seq_length)
            # if start_index >= args.max_enc_seq_length:
            #     continue
            # if len(end_index_list) != 0 and end_index_list[-1] >= args.max_enc_seq_length:
            #     continue
